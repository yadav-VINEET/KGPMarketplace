...
export default function SearchForm({action}: Props){
  ...
  return (
    <form
      ref={formRef}
      action={action}
      className="bg-white grow px-10 py-2 w-auto sm:w-1/4 sm:p-4 border-r flex flex-col gap-1 sm:gap-4 sm:sticky top-0">
      ...
      <div className="">
        <label className="mt-1">Filter by price</label>
